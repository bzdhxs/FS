"""SMA (Slime Mould Algorithm) feature selection.
...
@register_algorithm("SMA")
class SMASelector(BaseMealpySelector):
    default_epoch    = 200
    default_pop_size = 100
    default_penalty  = 0.2

    def create_optimizer(self):
        return OriginalSMA(epoch=self.epoch, pop_size=self.pop_size)
